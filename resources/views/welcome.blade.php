    ...
    <div class="flex flex-col">
        <div class="self-start mx-3 lg:mx-0">
            <div data-aos="fade-up" class="lg:ml-48 flex flex-col-reverse items-center bg-gradient-to-b from-neutral-900 via-neutral-800 to-neutral-900 rounded-lg shadow-md md:flex-row md:max-w-3xl overflow-hidden ">
                <div class="flex flex-col justify-between p-4 leading-normal">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-white dark:text-white">What is Primitive Garage?</h5>
                    <p class="mb-3 font-normal text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos, ex. Ut, repudiandae ex. Suscipit facere rem, laboriosam sapiente facilis et sunt ratione vel voluptates velit, maiores veniam adipisci inventore quam.</p>
                </div>
        ...
        <div class="self-end mx-3 lg:mx-0">
            <div data-aos="fade-up" class="lg:mr-48 mt-24 flex flex-col items-center bg-gradient-to-b from-neutral-900 via-neutral-800 to-neutral-900 rounded-lg shadow-md md:flex-row md:max-w-3xl overflow-hidden">
                ...
                <div class="flex flex-col justify-between p-4 leading-normal">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-white">Why is Primitive Garage?</h5>
                    <p class="mb-3 font-normal text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos, ex. Ut, repudiandae ex. Suscipit facere rem, laboriosam sapiente facilis et sunt ratione vel voluptates velit, maiores veniam adipisci inventore quam.</p>
                </div>
            </div>
        </div>
            ...
            <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto mt-24 mb-16 lg:my-0">
                <div id="profile" class="relative w-full lg:w-2/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-gradient-to-b from-neutral-900 via-neutral-800 to-neutral-900 mx-6 lg:mx-0">
                    <div class="p-4 md:p-12 text-center lg:text-left">
                        ...
                        <div class="block md:hidden rounded-full ring-2 ring-orange-300 lg:rounded-xl shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center" style="background-image: url('img/who.jpg')"></div>
                        <div class="hidden md:block rounded-full ring-2 ring-orange-300 lg:rounded-xl shadow-xl mx-auto -mt-24 h-72 w-72 bg-cover bg-center" style="background-image: url('img/who.jpg')"></div>
