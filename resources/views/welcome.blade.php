...
<div class="bg-black">
    ...
    <div data-aos="fade-up" class="content-middle md:-mt-24 relative overflow-hidden">
        <div class="max-w-2xl m-auto" style="font-family: 'Poppins'; background: linear-gradient(rgba(253, 253, 253, 0.988), rgb(255, 246, 235), rgb(255, 227, 168)); -webkit-text-fill-color: transparent; -webkit-background-clip: text; background-clip: text;">
            ...
            <p class="text-sm md:text-lg text-center mt-3 mx-6">Primitive Garage merupakan tempat yang tepat bagi kalian yang menginginkan miniatur automotif roda dua dengan harga terjangkau dan kualitas terbaik.</p>                                
        </div>
        <div class=" ">
            ...
            <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto mt-24 mb-16 lg:my-0">
                <div id="profile" class="relative w-full lg:w-2/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-gradient-to-b from-neutral-900 via-neutral-800 to-neutral-900 mx-6 lg:mx-0">
                    <div class="p-4 md:p-12 text-center lg:text-left">
                        ...
                        <p class="py-8 md:mx-24 text-sm">
                            Lebih dari segalanya, Primitive Garage menyenangkan bagi saya. 
                            Saya selalu mengutak-atik mainan sejak saya kecil dan semakin saya besar, 
                            begitu juga mainan saya! Primitive Garage merupakan sebuah outlet bagi 
                            saya untuk mengekspresikan sisi artistik saya serta melakukan 
                            sesuatu yang menyenangkan, sambil mengenal motorhead dan nerd 
                            motor lainnya seperti saya.
                        </p>         
                    </div>
                </div>            
            </div>
