        ...
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 space-y-4 flex flex-row">
                    <div>
                        <a href="#">
                            <img class="rounded-t-lg object-cover w-64" src="https://images.tokopedia.net/img/cache/500-square/VqbcmM/2022/7/24/367aa915-8b2d-4162-9687-ee7fa0f0c2cc.jpg" alt="">
                        </a>
                        <h5 class="mb-2 text-lg md:text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Noteworthy technology acquisitions 2021</h5>
                    </div>
                    <div class="flex flex-col mb-2 overflow-auto max-h-56 sm:max-h-80">
                        ...
                        <div class="flex flex-col md:flex-row mt-2">
                            ...
                            <p class="ml-1 md:ml-2 text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400">4.95 out of 5</p>
                        </div>
                        <div class="rounded py-2 px-3 mt-4" style="background-color: #F2F2F2">
                            <p class="text-sm text-purple">
                                Tom Cruise
                            </p>
                            <p class="text-sm mt-1">
